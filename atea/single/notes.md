...
/usr/bin/docker create --name ateabb -p 10000:80 -p 15984:5984 -e ATEA_APP_MAP="ATEA_CFE_USER:BASIC:TEST,ATEA_CFE_POWER:POWER:TEST,ATEA_CFE_ADMIN:ADMIN:TEST" ateabb/single
```
